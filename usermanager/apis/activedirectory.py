from ldap3 import Server, Connection, NTLM, ALL  # , MODIFY_REPLACE, MODIFY_ADD
import json
import uuid
# import user
...
def convertGuid(rdGuid):
        # Function for Formating AD ObjectGuid in Little Endian Format for
        # Searches (e.g. 7fcb5751-bb65-4035-aa51-230a715faa8a will return
        # \51\57\CB\7F\65\BB\35\40\AA\51\23\0A\71\5F\AA\8A)
